...
###############################################################################
#
# Copyright (C) 2015-2020 Daniel Rodriguez (original: https://github.com/mementum/backtrader/blob/0426c777b0abdfafbb0988f5c31347553256a2de/samples/oandatest/oandatest.py)
...
def parse_args(pargs=None):
    parser = argparse.ArgumentParser(
        ...
        description='Test KabuS integration')
    ...
    parser.add_argument('--api_key', default=None, type=str,
                        required=False, action='store',
                        help=('The api key to access to the server'))

    parser.add_argument('--postman_return_code', default=None, type=int,
                        required=False, action='store',
